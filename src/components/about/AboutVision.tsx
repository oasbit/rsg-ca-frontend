...
export function AboutVision({ title, body }: AboutVisionProps) {
  return (
    <SectionTransition className="relative overflow-hidden bg-black pt-6 pb-4 text-white sm:pt-12 lg:pt-24 lg:pb-10">
      <Image
      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6 text-center lg:px-10">
        ...
        <Reveal variant="fadeUp" delay={0.12}>
          <blockquote className="mt-5 sm:mt-10 lg:mt-20">
        ...
        <Reveal variant="fadeUp" delay={0.22}>
          <div className="mt-5 flex flex-col items-center gap-3 sm:mt-10 lg:mt-20">
        ...
        <Reveal variant="fade" delay={0.28}>
          <div className="mt-5 h-px w-full bg-white/10 sm:mt-10 lg:mt-20" />
        </Reveal>
      </div>
    </SectionTransition>
  );
