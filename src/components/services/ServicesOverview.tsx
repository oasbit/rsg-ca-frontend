...
export function ServicesOverview({ services }: ServicesOverviewProps) {
  return (
    <SectionTransition className="bg-black py-6 text-white sm:py-12 lg:py-20">
            ...
            return (
              <RevealStaggerItem key={service.title}>
                <Link
                  ...
                  className="group flex h-full flex-col items-center rounded-2xl border border-white/10 bg-black/30 px-4 py-4 text-center transition-all duration-400 hover:border-accent/40 hover:bg-black/50 sm:px-6 sm:py-6"
                >
