...
export default async function ContactPage() {
  ...
  return (
    <>
      ...
      />
      <ValuesBand />
      <SectionTransition className="relative overflow-hidden bg-black py-6 text-white sm:py-14 lg:py-24">
        ...
        />
        <div className="relative mx-auto grid max-w-7xl gap-5 px-4 sm:px-6 sm:gap-10 lg:grid-cols-2 lg:gap-16 lg:px-10">
          <ContactInfo
            phone={content.phone}
            email={content.email}
