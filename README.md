...
| `story_eyebrow` | Text |
| `story_headline` | Text |
| `story_paragraphs` | Repeater / textarea (array) — first item is the hero deck under the title; remaining items are secondary body |
...
The About hero emphasizes the founding sentence as a wider `bodyLead` under the title, with the “25 years…” paragraph as quieter supporting copy.

**Who We Are** no longer opens with the Rising Stars Athletics & Education origin clause; that sentence was removed per client edit.

**Principal Facilitator** uses updated bio copy (coach/developer framing, Human/Economic & Business Development doctorate, no Rising Stars pairing). The closing “Today, Dr. Peters…” line renders as a distinct full-width emphasis band.
...
- **`/services/team-building`** — dedicated Team Building program page (hero, "What We Do", Interactive & Engaging Development, Why Choose Us). The "Not Just Another Team-Building Exercise" band leads with a title deck, then a left check/X contrast tile (competitive advantage vs. the common gap) beside "How does the program work?".
...
| Service blocks / home tabs | Strategic Planning: `Andrew-Peters-1.jpeg`. Leadership / Team Building / Facilitation: generated editorial photos in `public/images/services/` (facilitation is a stand-in until the client-supplied consultant likeness is ready) |
